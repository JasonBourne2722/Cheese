...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xo(e,t,n){let r=new Float32Array(oo),i=new G(0,1,0);return new Ui({name:`SphericalGaussianBlur`,defines:{n:oo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function So(){return new Ui({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Co(){return new Ui({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wo(),fragmentShader:`
	...
	`}var To=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ti(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;var kl=new Dl(document.querySelector(`#game-shell`));kl.start();var Al=(e,t)=>{if(typeof kl.setInput==`function`){kl.setInput(e,t);return}kl.input[e]=t},jl=(e,t)=>{let n=!1,r=()=>{n=!1,e.classList.remove(`pressed`),Al(t,!1)},i=r=>{r&&r.preventDefault(),r?.pointerId!==void 0&&e.setPointerCapture&&e.setPointerCapture(r.pointerId),n=!0,e.classList.add(`pressed`),Al(t,!0)},a=e=>{e&&e.preventDefault(),n&&r()};e.addEventListener(`pointerdown`,i),e.addEventListener(`pointerup`,a),e.addEventListener(`pointercancel`,a),e.addEventListener(`mousedown`,i),e.addEventListener(`mouseup`,a),e.addEventListener(`touchstart`,i,{passive:!1}),e.addEventListener(`touchend`,a,{passive:!1}),e.addEventListener(`touchcancel`,a,{passive:!1}),e.addEventListener(`pointerleave`,e=>{n&&e.buttons===0&&a(e)}),window.addEventListener(`pointerup`,a),window.addEventListener(`mouseup`,a),window.addEventListener(`touchend`,a,{passive:!1}),window.addEventListener(`blur`,a)};document.querySelectorAll(`[data-hold]`).forEach(e=>jl(e,e.dataset.hold)),document.querySelector(`[data-tap="restart"]`).addEventListener(`click`,()=>kl.restartRace()),document.querySelectorAll(`[data-mode]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=Number(e.dataset.mode);kl.setPlayerMode(t),document.querySelectorAll(`[data-mode]`).forEach(e=>{e.classList.toggle(`active`,Number(e.dataset.mode)===t)})})});